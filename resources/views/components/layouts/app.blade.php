      ...
      <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
          <ul class="menu">
            ...
            <x-sidebar.sidebar-item class="has-sub" :active="request()->routeIs('deposits.*')">
              <x-sidebar.sidebar-link href="#" icon="bi bi-cash-stack">
                Pembayaran
              </x-sidebar.sidebar-link>

              <ul class="submenu">
                <x-sidebar.submenu-item :active="request()->routeIs('deposits.index')">
                  <x-sidebar.submenu-link :href="route('deposits.index')" wire:navigate>
                    Pembayaran Minggu Ini
                  </x-sidebar.submenu-link>
                </x-sidebar.submenu-item>

                <x-sidebar.submenu-item :active="request()->routeIs('deposits.filter')">
                  <x-sidebar.submenu-link :href="route('deposits.filter')" wire:navigate>
                    Filter Pembayaran
                  </x-sidebar.submenu-link>
                </x-sidebar.submenu-item>
              </ul>
