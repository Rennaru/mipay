          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                @endphp
                @forelse ($filteredResult as $index => $deposit)
                <tr wire:key="{{ $deposit->id }}">
                  <th scope="row">{{ $startIndex + $index }}</th>
                  <td>
                    <span class="text-uppercase badge bg-primary">{{ $deposit->student->name }}</span>
                  </td>
                  <td>{{ local_amount_format($deposit->amount) }}</td>
                  <td>{{ $deposit->date_paid }}</td>
                  <td class="text-center">
                    <span class="badge bg-primary">
                      <i class="bi bi-person-badge-fill"></i> {{ $deposit->createdBy->name }}
                    </span>
                  </td>
                </tr>
                @empty
